...
<tr>
<td class="tl"><span class="f_red">*</span>附件上传</td>
...
<tr>
<td class="tl"><span class="f_red">*</span>最终价格</td>
<td><input name="post[amount]" id="amount" type="text" size="60" value="<?php echo $amount;?>"/></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span>项目完成周期</td>
<td><input name="post[day]" id="day" type="text" size="60" value="<?php echo $day;?>"/>（天）为单位</td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span>卖家</td>
<td><input name="post[seller]" id="seller" type="text" size="60" value="<?php if(!$_seller){ echo $_username; }else {echo $_seller;}?>"/></td>
</tr>
<tr>
