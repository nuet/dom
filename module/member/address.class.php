...
class address {
    ...
    function address() {
		...
		$this->db = &$db;
		$this->fields = array('address','postcode','truename','telephone','mobile','hy_sort','pay_style','name','username','addtime','editor','edittime','listorder','note');
    }

	function pass($post) {
		global $L;
		if(!is_array($post)) return false;
		if(!$post['name']) return $this->_($L['pass_name']);
