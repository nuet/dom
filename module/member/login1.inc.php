...
if($submit) {
	...
	if(strlen($username) < 1) message($L['login_msg_username']);
	if(strlen($password) < 1) message($L['login_msg_password']);
	...
	if(is_telephone($username) && $option == 'username') $option = 'mobile';
