...
<tr>
<td class="tl">订单单号</td>
<td><?php echo $item['itemid'];?> (<?php echo $item[buyer_name];?>)<?php if($DT['trade']) { ?>(<?php echo $DT['trade_nm'];?>订单单号:<a href="https://lab.alipay.com/consume/queryTradeDetail.htm?tradeNo=<?php echo $item['trade_no'];?>" target="_blank" class="t"><?php echo $item['trade_no'];?></a>)<?php } ?></td>
</tr>
<tr>
<td class="tl">商品名称</td>
...
<?php  $item_psd[pic_upload]=pic_add($item_psd[upload]);?>
<li style='width:160px;height:180px;float:left;padding: 0 10px;border:1px solid #ccc'>
<a href="#" onclick="down('<?php echo $item_psd['id'];?>')" ><img src="<?php echo $CFG[url] ?>member/image/<?php echo $item_psd[pic_upload] ?>.ico"  onerror="nofind();"width="160" height="120"/></a>
<span style='text-align: center;
height: 20px;
...
<a href="<?php echo $item_doc['logo'] ?>" target="_blank"><img src="<?php echo $CFG[url] ?>member/image/<?php echo $item_doc[pic_logo] ?>.ico"  onerror="nofind();"width="160" height="90" /></a>
<span style='text-align: center;
height: 30px;
display: block;'>公司logo</span>
</li>
<li style='width:160px;height:120px;float:left;padding: 0 10px;border:1px solid #ccc'>
<a href="<?php echo $item_doc['contact'] ?>" target="_blank"><img src="<?php echo $CFG[url] ?>member/image/<?php echo $item_doc[pic_contact] ?>.ico" onerror="nofind();"  width="160" height="90" /></a>
<span style='text-align: center;
height: 30px;
display: block;'>公司介绍联系方式</span>
</li>
<li style='width:160px;height:120px;float:left;padding: 0 10px;border:1px solid #ccc'>
<a href="<?php echo $item_doc['lm'] ?>" target="_blank"><img src="<?php echo $CFG[url] ?>member/image/<?php echo $item_doc[pic_lm] ?>.ico" onerror="nofind();" width="160" height="90" /></a>
<span style='text-align: center;
height: 20px;
display: block;'>网站栏目结构</span>
</li>
<li style='width:160px;height:120px;float:left;padding: 0 10px;border:1px solid #ccc'>
<a href="<?php echo $item_doc['ad'] ?>" target="_blank"><img src="<?php echo $CFG[url] ?>member/image/<?php echo $item_doc[pic_ad] ?>.ico" onerror="nofind();" width="160" height="90" /></a>
<span style='text-align: center;
height: 20px;
