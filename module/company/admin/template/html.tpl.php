...
<input type="submit" value=" 更新设计师 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&update=1';" title="更新该模块所有所有设计师等信息"/>
</td>
</tr>
</table>
</form>
<form method="post">
<div class="tt">更新设计师</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<th>起始ID</th>
<th>结束ID</th>
