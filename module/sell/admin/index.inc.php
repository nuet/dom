...
if(in_array($action, array('', 'check', 'expire', 'reject', 'recycle'))) {
	$sfields = array('模糊', '标题', '产品品牌', '计量单位', '简介', '联系人', '联系电话', '联系地址', '电子邮件', '联系MSN', '联系QQ', '会员名', 'IP', '参数名1', '参数名2', '参数名3', '参数值1', '参数值2', '参数值3');
	$dfields = array('keyword', 'title', 'brand', 'unit', 'introduce', 'truename', 'telephone', 'address', 'email', 'msn', 'qq','username', 'ip', 'n1', 'n2', 'n3', 'v1', 'v2', 'v3');
