...
<td class="px11"><a style="color:blue;" href="javascript:Dwidget('?moduleid=16&amp;file=order&amp;action=show&amp;mallid=&amp;itemid=<?php echo $v[rid] ?>', '[<?php echo $v['rid'];?>] 订单列表');"><img src="<?php echo $CFG[url]?>member/image/psd.png" width='60px' height='60px'/></a></td>
