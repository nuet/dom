...
<tr>
<td class="tl"><span class="f_hid">*</span> 入围人数</td>
<td><input name="post[in_select]" type="text" size="30" value="<?php echo $in_select;?>"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 初稿淘汰人数</td>
<td><input name="post[scount]" type="text" size="30" value="<?php echo $scount;?>"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 手机网站价格</td>
<td><input name="post[mobprice]" type="text" size="30" value="<?php echo $mobprice;?>"/></td>
</tr>
<tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 响应式网站价格</td>
<td><input name="post[resprice]" type="text" size="30" value="<?php echo $resprice;?>"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 手机语言增加价格</td>
<td><input name="post[mlangprice]" type="text" size="30" value="<?php echo $mlangprice;?>"/></td>
</tr>
<tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 响应式语言增加价格</td>
<td><input name="post[rlangprice]" type="text" size="30" value="<?php echo $rlangprice;?>"/></td>
</tr>
...
<tr bgcolor="#FFFFFF" align="center">
<td><input name="post[n4]" type="text" size="10" value="<?php echo $n4;?>" id="n4"/></td>
<td><input name="post[v4]" type="text" size="40" value="<?php echo $v4;?>" id="v4"/></td>
</tr>
<tr bgcolor="#FFFFFF" align="center">
<td><input name="post[n5]" type="text" size="10" value="<?php echo $n5;?>" id="n5"/></td>
...
<td>淘汰资深奖金</td>
<td>淘汰高级奖金</td>
<td>选择模板 | <a href="?moduleid=<?php echo $moduleid ?>&file=express" class="t" target="_blank">管理模板</a></td>
</tr>
<tr bgcolor="#FFFFFF" align="center">
<td><input name="post[express_name_1]" type="text" id="express_name_1" size="10" value="<?php echo $express_name_1;?>" /></td>
<td><input name="post[last_money]" type="text" id="last_money" size="5" value="<?php echo $last_money;?>" /></td>
<td><input name="post[rmoney_1]" type="text" id="rmoney_1" size="5" value="<?php echo $rmoney_1;?>" /></td>
<td><input name="post[rmoney_2]" type="text" id="rmoney_2" size="5" value="<?php echo $rmoney_2;?>" /></td>
<td><input name="post[rmoney_3]" type="text" id="rmoney_3" size="5" value="<?php echo $rmoney_3;?>" /></td>
<td><input name="post[smoney_1]" type="text" id="smoney_1" size="5" value="<?php echo $smoney_1;?>" /></td>
<td><input name="post[smoney_2]" type="text" id="smoney_2" size="5" value="<?php echo $smoney_2;?>" /></td>
<td><input name="post[smoney_3]" type="text" id="smoney_3" size="5" value="<?php echo $smoney_3;?>" /></td>
<td>
...
><?php echo $v['title'];?>[<?php echo $v['express'];?>,<?php echo $v['last_money'];?>,<?php echo $v['rmoney_1'];?>,<?php echo $v['rmoney_2'];?>,<?php echo $v['rmoney_3'];?>,<?php echo $v['smoney_1'];?>,<?php echo $v['smoney_2'];?>,<?php echo $v['smoney_3'];?>,<?php echo $v['note'];?>]</option>
<?php } } ?>
</select>
</td>
</tr>
...
function Dexpress(i, s) {
	if(Dd('express_'+i).value > 0) {
		...
		Dd('last_money').value = t2[1];
		Dd('rmoney_1').value = t2[2];
		Dd('rmoney_2').value = t2[3];
		Dd('rmoney_3').value = t2[4];
		Dd('smoney_1').value = t2[5];
		Dd('smoney_2').value = t2[6];
		Dd('smoney_3').value = t2[7];
	} else {
