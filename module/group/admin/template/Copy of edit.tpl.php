...
<td><input name="post[thumb]" id="thumb" type="text" size="60" value="<?php echo $thumb;?>"/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>,370,410, Dd('thumb').value);" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview(Dd('thumb').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('thumb').value='';" class="jt">[删除]</span><span id="dthumb" class="f_red"></span></td>
</tr>
<tr>
...
<tr bgcolor="#FFFFFF" align="center">
<td>移动版<textarea id="n2" cols=50  rows=5  name="post[n2]"><?php if($action=='add'){echo "无移动版<br />1、无手机专用网站；<br />2、手机也访问PC站；<br />3、以后可选购；|手机版<br />1、有手机网站；<br />2、PC访问PC站；<br />3、手机访问手机站；|响应式网站<br />1、自动适应显示器；<br />2、有手机和平板站；<br />3、PC访问PC站;";}else{echo $n2;}?></textarea></td>
<td><input name="post[v2]" type="text" size="40" value="<?php if($action=='add'){ echo "无移动版|手机版|响应式网站"; }else{ echo $v2;}?>" id="v2"/></td>
<td><input name="post[p2]" type="text" size="15" value="<?php if($action=='add'){ echo "0|1500|2500 "; }else{ echo $p2;}?>" id="p2"/></td>
</tr>
<tr bgcolor="#FFFFFF" align="center">
