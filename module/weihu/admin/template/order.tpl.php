...
<option value="0">买家发起订单,等待卖家确认</option>
<option value="1">卖家已确认订单,等待买家付款</option>
<option value="2">买家已付款,等待卖家发货</option>
<option value="3">卖家已发货,等待买家确认</option>
<option value="4">交易成功</option>
<option value="5">买家申请退款</option>
<option value="6">已退款给买家</option>
<option value="7">已付款给卖家</option>
<option value="8">买家关闭交易</option>
<option value="9">卖家关闭交易</option>
