...
<tr>
<td class="tl">订单单号</td>
<td><?php echo $order['itemid'];?> <?php if($DT['trade']) { ?>(<?php echo $DT['trade_nm'];?>订单单号:<a href="https://lab.alipay.com/consume/queryTradeDetail.htm?tradeNo=<?php echo $order['trade_no'];?>" target="_blank" class="t"><?php echo $order['trade_no'];?></a>)<?php } ?></td>
</tr>
<tr>
<td class="tl">商品名称</td>
...
<tr>
<td class="tl">测试帐号</td>
<td><input type="text" name="username" value="<?php echo $cm['username'];?>" id="username"/></td>
</tr>
<tr>
<td class="tl">测试密码</td>
<td><input type="text" name="password" value="<?php echo $cm['password'];?>" id="password"/></td>
</tr>
<tr>
<td class="tl">测试地址</td>
<td><input type="text" name="url" value="<?php echo $cm['url'];?>" id="url"/>(必须加上http://)</td>
</tr>
<tr>
<td class="tl">后台测试地址</td>
<td><input type="text" name="adminurl"  value="<?php echo $cm['adminurl'];?>" id="adminurl"/>(必须加上http://)</td>
</tr>
</table>
...
<td><input type="text" name="num"  value="<?php echo $cm['num'];?>" id="adminurl"/>(最后一步添加,必须加上http://)</td>
</tr>
