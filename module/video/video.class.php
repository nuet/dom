...
class video {
    ...
    function video($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','areaid','level','title','style','fee','introduce','tag','thumb','video','mobile','width','height','player','status','hits','username','addtime','editor','edittime','ip','template', 'linkurl','filepath','note');
    }
