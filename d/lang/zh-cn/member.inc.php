...
$L['order_start']='订单创建通知';
$L['order_index_tz']='订单更新通知';
$L['order_inselect_tz']='订单入围通知';
$L['order_index_gj']='订单稿件通知';
$L['order_acce']='订单完成通知';
$L['ziliao_shenhe']='订单资料审核通知';
$L['wel_index'] = '您好{V0},您的订单{V1}已有设计师设计出首页了,请注意查看';
$L['wel_lm'] = '您好{V0},您的订单{V1}已有设计师设计出栏目页了,请注意查看';
$L['wel_in_select'] = '恭喜你{V0},您对订单{V1}的作品被客户入围,请注意查看';

$L['fapiao_tz']='发票申请审核通知';

$L['pass_title'] = '请填写标题';
$L['pass_content'] = '请填写内容';
$L['pass_typeid'] = '请选择分类';
$L['pass_url'] = '请填写网址';
$L['pass_name'] = '请填写公司或者网站名称';
$L['pass_address'] = '请选择地区';
...
$L['login_fall']="此操作必须是会员才能进行";
$L['order_last']="恭喜您，订单创建成功";
$L['edit_title'] = '修改资料';
$L['edit_invite'] = '会员推广';
$L['edit_profile'] = '完善资料';
...
$L['favorite_sfields'] = array($L['search_by'], $L['search_by_title'], '描述');
...
$L['friend_sfields'] = array($L['search_by'], '姓名', '设计师', '职位', '电话', '手机', '主页', 'Email', 'QQ', '阿里旺旺', 'MSN', 'Skype', '会员', $L['search_by_note']);
...
$L['member_username_match'] = '小写字母、数字、下划线组合';
$L['member_num']='不能全为数字';
...
$L['member_company_null'] = '请填写设计师名称';
$L['member_company_bad'] = '无效的设计师名称';
$L['member_company_reg'] = '设计师名称已经存在';
$L['member_company_ban'] = '此设计师名已经被禁止注册';
$L['member_type_null'] = '请选择设计师类型';
$L['member_telephone_null'] = '请填写设计师电话';
$L['member_regyear_null'] = '请填写设计师注册年份';
$L['member_address_null'] = '请填写设计师地址';
$L['member_introduce_null'] = '设计师介绍不能大于500字';
$L['member_business_null'] = '请填写设计师主要经营范围';
$L['member_catid_null'] = '请选择设计师主营行业';
...
$L['trade_num_last_success']="备案号添加成功，请等待上线。如需更改备案号，请联系专属客服";
...
$L['trade_confirm_index_fall']="很遗憾，本订单上传作品的设计师已满,您可以选择其他订单";

$L['xuangao_confirm_fall']='选稿数量和本套餐不符,请重新选择作品';
...
$L['trade_status'] = array(
	'<i style="color:#0000FF;">等待付款</i>',
	'<i style="color:#0000FF;">等待提交需求</i>',
	'<i style="color:#0000FF;">需求已提交<br/>等待入围初稿</i>',
	'<i style="color:#FF6600;">确定最终首页作品</i>',
	'<i style="color:#008080;">等待付款后<br/>设计栏目页</i>',
	'<i style="color:#FF0000;">等待设计师<br/>上传作品</i>',
	'<i style="color:#008000;">买家已付款<br/>等待网站制作最终页</i>',
	'<i style="color:#FF0000;text-decoration:underline;">项目制作完成<br>等待确认</i>',
	'<i style="color:#0000FF;text-decoration:underline;">交易成功</i>',
	'<i style="color:#FF6600;text-decoration:underline;">买家关闭交易</i>',
	'<i style="color:#888888;text-decoration:line-through;">卖家关闭交易</i>',
);
$L['sjs_trade_status'] = array(
		'<i style="color:#0000FF;">等待付款</i>',
		'<i style="color:#0000FF;">等待提交需求</i>',
		'<i style="color:#0000FF;">需求已提交<br/>等待入围初稿</i>',
		'<i style="color:#FF6600;">确定最终首页作品</i>',
		'<i style="color:#008080;">等待客户付款后<br/>设计栏目页</i>',
		'<i style="color:#FF0000;">等待设计师<br/>上传作品</i>',
		'<i style="color:#008000;">买家已付款<br/>等待网站制作最终页</i>',
		'<i style="color:#FF0000;text-decoration:underline;">网站制作完成<br>等待确认</i>',
		'<i style="color:#0000FF;text-decoration:underline;">交易成功</i>',
		'<i style="color:#FF6600;text-decoration:underline;">买家关闭交易</i>',
		'<i style="color:#888888;text-decoration:line-through;">卖家关闭交易</i>',
);

$L['logo_trade_status'] = array(
		'<i style="color:#0000FF;">等待付款</i>',
		'<i style="color:#0000FF;">等待提交需求</i>',
		'<i style="color:#0000FF;">需求已提交<br/>等待入围初稿</i>',
		'<i style="color:#FF6600;">确定最终首页作品</i>',
		'<i style="color:#008080;">确定最终首页作品</i>',
		'<i style="color:#FF0000;">确定最终首页作品</i>',
		'<i style="color:#008000;">确定最终首页作品</i>',
		'<i style="color:#FF0000;text-decoration:underline;">logo制作完成<br>等待确认</i>',
		'<i style="color:#0000FF;text-decoration:underline;">交易成功</i>',
		'<i style="color:#FF6600;text-decoration:underline;">买家关闭交易</i>',
		'<i style="color:#888888;text-decoration:line-through;">卖家关闭交易</i>',
);
...
$L['trade_msg_last'] = '此功能只能由网站制作方确认';
$L['trade_msg_null'] = '订单不存在';
$L['trade_price_fee_null'] = '请填写附加金额';
$L['trade_price_fee_name'] = '请填写附加金额名称';
$L['trade_price_edit_success'] = '订单修改成功';
$L['trade_input_xq_success']= '项目需求提交成功';
$L['trade_input_edit_xq_success']= '项目需求编辑成功';
$L['trade_input_index_success']='提交首页成功';
$L['trade_price_title'] = '修改价格';
$L['trade_detail_title'] = '订单详情';
$L['trade_confirm_success'] = '首页已上传，订单已确认，请等待买家首付款';

$L['trade_confirm_index_success']='您已入围你初稿的设计师，请最终确定一名设计师';

$L['trade_confirm_index_last_success']='您已确定栏目页，等待网站完成';
$L['trade_confirm_last_success']='您已确定首页，等待栏目页的制作';
$L['trade_confirm_logo_success']='您已成功确定首页';

$L['trade_confirm_index']='您已成功选择您喜欢的作品,请付款操作';
$L['trade_confirm_lm_success'] = '栏目已上传，请等待客户建议';

$L['trade_confirm_lm_xg']="栏目图片修改成功";
$L['trade_pay_order_success'] = '支付成功，金额暂时被锁定';
...
$L['trade_title'] = '收到的订单';
$L['trade_record_pay'] = '订单交易成功';
$L['trade_start_pay'] = '订单初稿佣金';
$L['trade_secord_pay'] = '订单入围佣金';
$L['trade_last_pay'] = '订单成功佣金';
...
$L['trade_message_t1'] = '站内交易提醒，您有一笔交易已经有设计师提交作品了(T{V0})';
$L['trade_message_s1'] = '站内交易提醒，恭喜您的作品被顾客看中，请您尽快完成下一步栏目页的制作(T{V0})';
$L['trade_message_w1'] = '顾客 <a href="{V0}" class="t">{V1}</a> 于 <span class="f_gray">{V2}</span> 更新了您接的订单<br/><a href="{V3}" class="t" target="_blank">&raquo; 请点这里立即处理或查看详情</a>';
...
$L['trade_message_n2'] = '站内交易提醒，您有一笔佣金到账(T{V0})';
$L['trade_message_m1'] = '买家 <a href="{V0}" class="t">{V1}</a> 于 <span class="f_gray">{V2}</span> 完成了订单，请查看您的佣金<br/><a href="{V3}" class="t" target="_blank">&raquo; 请点这里立即处理或查看详情</a>';
...
$L['validate_company_title'] = '设计师认证';
$L['validate_company_name'] = '请填写设计师名';
