...
class quote {
    ...
    function quote($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','areaid','level','title','style','fee','introduce','thumb','tag','status','hits','username','addtime','adddate', 'editor','edittime','ip','template', 'linkurl','filepath','note');
    }
