...
class express {
    ...
    function express() {
		global $db;
		$this->table = $db->pre.'pingmian_express';
		$this->db = &$db;
		$this->fields = array('parentid','areaid','title','express','last_money','rmoney_1','rmoney_2','rmoney_3','smoney_1','smoney_2','smoney_3','username','addtime','listorder','note');
    }
