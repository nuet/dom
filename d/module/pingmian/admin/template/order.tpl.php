...
<td>
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=edit&mallid=<?php echo $mallid;?>&itemid=<?php echo $v['itemid'];?>"><img src="admin/image/edit.png" width="16" height="16" title="编辑" alt=""/></a>&nbsp;
...
<option value="6">买家已付款,等待网站制作最终页</option>
<option value="7">网站制作完成,等待确认</option>
