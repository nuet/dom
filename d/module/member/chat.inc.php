...
$result = $db->query("SELECT * FROM d_article_21 A,d_category B where A.catid=B.catid and A.catid=$catid and B.group_list in($_groupid) order by addtime desc LIMIT 8");
