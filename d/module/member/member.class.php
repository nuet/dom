...
class member {
	...
	function is_member($member) {
		...
		if($this->userid) {
			...
			if($member['groupid'] > 5) {
				if(word_count($member['introduce']) > 500) return $this->_($L['member_introduce_null']);
	...
	function add($member) {
		...
		$company_fields = array('username','groupid','company','type','catid','catids','areaid', 'mode','capital','regunit','size','regyear','sell','buy','business','telephone','idcard','mail','address','postcode','homepage','introduce','thumb','keyword','linkurl');
	...
	function edit($member)	{
		...
		$company_fields = array('company','type','areaid', 'catid','catids','business','mode','regyear','regunit','capital','size','address','postcode','telephone','idcard','mail','homepage','sell','buy','introduce','thumb','keyword','linkurl','groupid','domain','icp','validated','validator','validtime','skin','template');
