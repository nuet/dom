...
<tr>
<td class="tl"><span class="f_hid">*</span> 维护订单ID</td>
<td><a href="?moduleid=99&file=order&action=show&mallid=&itemid=<?php echo $whid;?>" style="color:blue"><?php echo $whid;?></a></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 对应域名</td>
<td><a href="<?php echo $ym;?>" target="_blank"  style="color:blue"><?php echo $ym;?></a></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 操作内容</td>
<td><?php echo $lb_value;?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span>此功能操作剩余次数<br></td>
<td><?php echo $lb_count;?></td>
</tr>
