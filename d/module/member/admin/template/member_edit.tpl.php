...
<div class="tt"><span class="f_hid">*</span> 设计师资料</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
...
<td><input type="text" size="20" name="member[idcard]" id="idcard" value="<?php echo $idcard;?>"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 联系方式</td>
<td><input type="text" size="20" name="member[telephone]" id="idcard" value="<?php echo $telephone;?>"/></td>
</tr>
<tr>
...
<td class="tl"><span class="f_red">*</span> 自我介绍</td>
