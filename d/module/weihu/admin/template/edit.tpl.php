...
<tr>
<td class="tl"><span class="f_hid">*</span> 网站代码程序恢复次数</td>
<td><input name="post[dmhf]" type="text" size="10" value="<?php echo $dmhf;?>"/>次</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 网站后台密码重置次数</td>
<td><input name="post[mmcz]" type="text" size="10" value="<?php echo $mmcz;?>"/>次</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 网站JS处理次数</td>
<td><input name="post[jscl]" type="text" size="10" value="<?php echo $jscl;?>"/>次</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 后台使用培训次数</td>
<td><input name="post[htsh]" type="text" size="10" value="<?php echo $htsh;?>"/>次</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 网站页面维护次数</td>
<td><input name="post[ymwh]" type="text" size="10" value="<?php echo $ymwh;?>"/>次</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 网站数据库维护次数</td>
<td><input name="post[sjwh]" type="text" size="10" value="<?php echo $sjwh;?>"/>次</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 网站文字信息录入次数</td>
<td><input name="post[wzlr]" type="text" size="10" value="<?php echo $wzlr;?>"/>次</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 网站产品信息录入次数</td>
<td><input name="post[cplr]" type="text" size="10" value="<?php echo $cplr;?>"/>次</td>
</tr>
