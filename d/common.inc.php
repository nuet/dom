...
$colors_all[0][key]="red";
$colors_all[0][name]="红色系";
$colors_all[1][key]="yellow";
$colors_all[1][name]="黄色系";
$colors_all[2][key]="green";
$colors_all[2][name]="绿系";
$colors_all[3][key]="blue";
$colors_all[3][name]="蓝色系";
$colors_all[4][key]="purple";
$colors_all[4][name]="紫色系";
$colors_all[5][key]="pink";
$colors_all[5][name]="粉色系";
$colors_all[6][key]="brown";
$colors_all[6][name]="棕色系";
$colors_all[7][key]="black";
$colors_all[7][name]="黑白色系";
$colors_all[8][key]="all";
$colors_all[8][name]="彩色系";

$colors_alls[red]="红色系";
$colors_alls[yellow]="黄色系";
$colors_alls[green]="绿系";
$colors_alls[blue]="蓝色系";
$colors_alls[purple]="紫色系";
$colors_alls[pink]="粉色系";
$colors_alls[brown]="棕色系";
$colors_alls[black]="黑白色系";
$colors_alls[all]="彩色系";
...
if($destoon_auth) {	
	...
	$umd=$db->get_one("select i.*,s.username as tname,s.truename as truename from d_member i left join d_member s on s.username = i.support where i.username='$_username'");
	$_kf=$umd[tname];
	$_kfname=$umd[truename];
