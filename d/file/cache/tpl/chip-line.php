...
line.png" width="10" height="10" align="absmiddle"/></a>&nbsp;&nbsp; <a href="<?php echo $MODULE['2']['linkurl'];?>">会员中心</a> &nbsp;&nbsp;<a href="#">我的订单</a>&nbsp;&nbsp;<a href="<?php echo $MODULE['2']['linkurl'];?>favorite.php">我的收藏</a>&nbsp;&nbsp;付款方式 &nbsp;&nbsp;<a href="<?php echo $MODULE['2']['linkurl'];?>logout.php">退出</a>&nbsp;&nbsp;<?php if($admin_user) { ?><a href="<?php echo $CFG['url'];?>/index.php?action=logout">注销授权</a><?php } ?>
</div>';
<?php } else { ?>
<?php if($EXT['oauth']) { ?>
