...
function loadMore(n)
{
    $.ajax({
        ...
        $item = $('<li><a href="<?php echo $CFG['url'];?>mall/search_last.php?itemid='+oProduct.itemid+'" ><div class="DingzhiSHowZDIm"><img src="'+oProduct.thumb+'" alt="" class="sy_thumb"><span class="yinBg"><div class="yuanS"><img src="<?php echo DT_SKIN;?>image/zoom_icon.png"></div></span></div></a><p>'+oProduct.buyer_name+'</p></li>').hide();
