    ...
    success : function(json)
    {
        ...
        if(typeof json == 'object')
        {
            ...
            for(var i=0, l=json.length; i<l; i++)
            {
                ...
                $item = $('<li><div class="Index_Moban_zs_img"><a href="<?php echo $CFG['url'];?>group/'+oProduct.linkurl+'" target="_blank"><img src="'+oProduct.thumb+'" class="pimg" alt=""></a><div class="MoBanBlue"><span class="Left"> <a href="<?php echo $CFG['url'];?>group/'+oProduct.linkurl+'" target="_blank" title>查看详情</a></span><span class="Right"><a href="'+oProduct.url+'" target="_blank">浏览网站</a></span></div></div><div class="GoSM">名称：'+oProduct.title+'</div><div class="JzTc">行业：'+oProduct.catname+'</div></li>').hide();
                //$item = $('<li><div class="Index_Moban_zs_img"><a href=""><img src="<?php echo DT_SKIN;?>/image/Index_Anli_show1.fw.png" alt=""></a> <div class="MoBanBlue"><span class="Left"><a href="" title>查看详情</a></span><span class="Right"><a href="">浏览网站</a></span></div> </div><div class="GoSM">名称：上海科技创新有限公司</div><div class="JzTc">行业：展示站1套餐</div></li>').hide();
                $row.append($item);
...
<div class="oyw_tm"><h3 class="clearfix"><span style="font-size:14px;font-family:微软雅黑; padding:3px 0px;;" class="fl"><?php echo $_truename;?> <?php echo $MG['groupname'];?>，您好</span><span  style="padding-top:13px; margin-left:10px;">
...
<div class="oyw_user clear">
  ...
  <div class="sjs_in_in clear">
   ...
   <?php } else if($_groupid >5) { ?>
       <div class="oyw_tm"><h3 class="clearfix"><span style="font-size:14px;font-family:微软雅黑; padding:3px 0px;;" class="fl"><?php echo $_company;?> <?php echo $MG['groupname'];?>，您好</span><span  style="padding-top:13px; margin-left:10px;">
...
<script type="text/javascript">
   ...
   scroll(".MoBan_yZNew_pro",".sPrev1",".sNext1","#MoBan_yZNew_NQ_lin1",100,true);
   scroll(".MoBan_yZNew_pro",".sPrev2",".sNext2","#MoBan_yZNew_NQ_lin2",100,true);
   scroll(".MoBan_yZNew_pro",".sPrev3",".sNext3","#MoBan_yZNew_NQ_lin3",100,true);
   scroll(".MoBan_yZNew_pro",".sPrev4",".sNext4","#MoBan_yZNew_NQ_lin4",100,true);
    </script>
<!-- 精品网站结束 -->
