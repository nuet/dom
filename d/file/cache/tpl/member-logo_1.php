...
<input type="hidden" name="confirm_order" value="2"/>
                     <input name="zl" id="fileurl1" type="text" class='txt' size="50" value="<?php echo $fileurl1;?>"/>       
                          ...
                          <?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;    <input type="text" name="fileField" class="file" id="fileField" size="28" onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl1').value, 'fileurl1', 'doc|rar|zip');" /><?php } ?>
