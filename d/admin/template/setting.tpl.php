...
<tr>
<td class="tl">网站地址</td>
<td><input name="config[url]" type="text" value="<?php echo $url;?>" size="40"/><?php tips('请添写完整URL地址,例如http://www.omooo.com.cn/<br/>注意以 / 结尾');?></td>
</tr>
<tr>
...
<tr>
<td class="tl">行业分类</td>
<td><textarea name="setting[sort]" id="sort" style="width:500px;height:50px;"><?php echo $sort;?></textarea><br/>换行分割;
</td> 
</tr>
