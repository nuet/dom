...
<tr>
<td class="tab" id="my"><a href="mail.php"><span>我的订阅</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="list"><a href="mail.php?action=list"><span>邮件列表</span></a></td>
</tr>
</table>
</div>
<?php if($action == 'list') { ?>
...
<td align="left"><a href="mail.php?action=show&itemid=<?php echo $v['itemid'];?>" class="t"><?php echo $v['title'];?></a></td>
...
<tr>
<td class="tl"> </td>
<td class="tr" height="50"><input type="submit" name="submit" value=" 订 阅 " class="btn"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value=" 退 订 " class="btn" onclick="if(confirm('您确定要取消所有订阅吗？')) Go('?action=cancel');"/></td>
</tr>
</table>
</form>
