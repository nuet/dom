...
<!-- 建站资料选项卡 -->
  ...
  <div class="js_case clear">
    ...
    <li><a href="trades.php?itemid=<?php echo $itemid;?>&action=update&step=logo&forward=<?php echo $_GET['forward'];?>">平面需求</a></li>
        <li class="on"><a href="trades.php?itemid=<?php echo $itemid;?>&action=update&step=logo_index&forward=<?php echo $_GET['forward'];?>">平面设计</a></li>
      </ul>
    </div>
...
<?php } ?>
                ...
                <div class="u_jzzl_index_rw_time">
                    <b>首页入围：本套餐可以选择<?php echo $malls['in_select'];?>件初稿&nbsp;</b> <i> 确认倒计时：<?php echo $td['lefttime'];?></i>
                </div>
...
<div class="u_jzzl_index_sj" id="u_jzzl_index_sj">
        ...
        <p>注：首页效果确认，确认后设计师会在4个工作日内为您设计网站栏目页及内页。确认后首页不再更改，如果确认效果后再更改，根
据能会收取一定的费用。如需更改，请联系客服。</p>
<span> <input type="submit" value="确认作品" name="submit"></span>
        </div>
        <?php } else { ?>
        <div class="u_jzzl_index_sj_cont5">
        <p>注：首页效果确认，请支付首页进度款，付款后，设计师会在4个工作日内为您设计网站栏目页及内页。确认后首页不再更改，如果确认效果后再更改，根
据能会收取一定的费用。如需更改，请联系客服。</p>
