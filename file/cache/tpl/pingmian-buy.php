...
<div style="padding:3px 0 3px 0;">备注：<input type="text" name="post[<?php echo $t['key'];?>][note]" value="" size="20" style="border:#CCCCCC 1px solid;" maxlength="100" title="限100字以内"/>&nbsp;
...
<td>
<select name="post[<?php echo $t['key'];?>][express]" id="express_<?php echo $t['key'];?>" onchange="calculate();Dd('receive').value=this.options[selectedIndex].innerHTML;">
<?php if($t['fee_start_1']>0 || $t['fee_start_2']>0 || $t['fee_start_3']>0) { ?>
...
<td>
<input type="text" size="10" name="add[receive]" id="receive" value="<?php echo $receive;?>"/>
