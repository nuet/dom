...
<img src="<?php echo useravatar($_username, 'large');?>&time=<?php echo $DT_TIME;?>" title="大头像"/>
...
uploadUrl: '<?php echo DT_PATH;?>api/avatar/upload.php?code=<?php echo encrypt("$_userid");?>',
uploadSrc: false,
