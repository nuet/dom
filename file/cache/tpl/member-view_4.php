  ...
  <div class="js_case clear">
    ...
    <div class="u_jzzl" id="u_jzzl">
        ...
        <b>自己手写或工具制作的首页及其他页面框架图片：</b>
         <a href="<?php echo $xq['kj'];?>" target="_blank"><img src="<?php echo $CFG['url'];?>/member/image/<?php echo $xq['pic_kj'];?>.ico" alt=""onerror="nofind();"><img src="<?php echo DT_SKIN;?>/image/zipdown.jpg" alt="">主站下载</a>
        </div>
        <?php } ?>
        <div class="u_jzzl_tjhshow_1">
        <span><b>参考网站</b></span>
        ...
        <img src="<?php echo $CFG['url'];?>/member/image/<?php echo $xq['pic_logo'];?>.ico" class="ico_img" onerror="nofind();"  alt=""><i>
        <img src="<?php echo DT_SKIN;?>/image/zipdown.jpg" alt=""><a href="<?php echo $xq['logo'];?>">主站下载</a></i>
        </span>
        <span>
        <span>公司介绍及联系方式文档：</span> 
        <img src="<?php echo $CFG['url'];?>/member/image/<?php echo $xq['pic_contact'];?>.ico"onerror="nofind();" class="ico_img" alt=""><i>
        ...
        <span><span>
        网站栏目结构: </span>
        <img src="<?php echo $CFG['url'];?>/member/image/<?php echo $xq['pic_lm'];?>.ico" onerror="nofind();"class="ico_img" alt=""><i>
        <img src="<?php echo DT_SKIN;?>/image/zipdown.jpg" alt=""><a href="<?php echo $xq['lm'];?>">主站下载</a></i>
        </span>
        <span><span>
        网站主题图片及广告语:  </span>
        <img src="<?php echo $CFG['url'];?>/member/image/<?php echo $xq['pic_ad'];?>.ico" onerror="nofind();"class="ico_img" alt=""><i>
        ...
        <?php $v['pic_zl']=pic_add($v['zl']);?>
        <span>
        <img src="<?php echo $CFG['url'];?>/member/image/<?php echo $v['pic_zl'];?>.ico" onerror="nofind();"class="ico_img" alt=""><br/>
        ...
        <div class="u_jzzl_tjhshow_bc2 clear">
          <form action="trade.php" method="post" enctype="multipart/form-data" class="file-box">
        <i>产品、服务、新闻、案例等资料补充：</i>
...
<input type="hidden" name="confirm_order" value="2"/>
                     <input name="zl" id="fileurl1" type="text" class='txt' size="50" value="<?php echo $fileurl1;?>"/>       
                          <input type='button' class='btn1' value='选择文件' />            
                         
                          <?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;    <input type="text" name="fileField" class="file" id="fileField" size="28" onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl1').value, 'fileurl1', 'doc|rar|zip|docx|wps');" /><?php } ?>
    
                      
                          <!--<input type="submit" name="submit" class="btn" value="上传" />--> 支持文件格式：doc,rar,zip
        <i><a href="">例子下载>></a></i>
        <input type="submit" value="上&nbsp;&nbsp;传" class="u_jzzl_tjhshow_bc2_btn">
                </form>
        </div>
        </div>
        <div class="u_jzzl_tjhshow_3">
        <form method="post" action="trade.php" id="dform">
<input type="hidden" name="forward" value="trade.php?itemid=<?php echo $itemid;?>&action=update&step=upload_5&"/>
<input type="hidden" name="action" value="<?php echo $action;?>"/>
<input type="hidden" name="step" value="<?php echo $step;?>"/>
<input type="hidden" name="itemid" value="<?php echo $itemid;?>"/>
<input type="hidden" name="confirm_order" value="1"/>
        ...
        <p><input type="submit" value="提 &nbsp;&nbsp;交" name="submit"></p>
        </form>
        </div>
        </div>
        <!-- 资料提交后页面显示结束 -->
