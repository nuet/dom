  ...
  <div class="js_case clear">
    <div class="js_title cf">
      ...
      <ul class="js_title-list cf">
             <li class="on"><a href="trades.php?itemid=<?php echo $itemid;?>&action=update&step=upload_5&forward=<?php echo $_GET['forward'];?>">平面需求</a></li>
        <li><a href="trades.php?itemid=<?php echo $itemid;?>&action=update&step=index&forward=<?php echo $_GET['forward'];?>">平面设计</a></li>
    ...
    <div class="u_jzzl" id="u_jzzl">
        ...
        <div class="u_jzzl_tjhshow_bc2 clear">
          <form action="trades.php" method="post" enctype="multipart/form-data" class="file-box">
        <i>产品、服务、新闻、案例等资料补充：</i>
        <input type="hidden" name="forward" value="<?php echo $CFG['url'];?>/member/trades.php?itemid=<?php echo $itemid;?>&action=<?php echo $action;?>&step=<?php echo $step;?>"/>
...
<input type="hidden" name="forward" value="trades.php?itemid=<?php echo $itemid;?>&action=update&step=upload_5&"/>
<input type="hidden" name="action" value="<?php echo $action;?>"/>
<input type="hidden" name="step" value="<?php echo $step;?>"/>
<input type="hidden" name="itemid" value="<?php echo $itemid;?>"/>
