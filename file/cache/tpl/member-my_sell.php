...
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="type"><a href="javascript:Dwidget('type.php?item=product', '[<?php echo $MODULE['5']['name'];?>分类]', 600, 300);"><span><?php echo $MODULE['5']['name'];?>分类<span class="px10">(<?php echo $nums['0'];?>)</span></span></a></td>
<?php } ?>
</tr>
</table>
</div>
...
<td class="tr"><?php echo $mycatid_select;?>&nbsp; <a href="javascript:Dwidget('type.php?item=product', '[<?php echo $MODULE['5']['name'];?>分类]', 600, 300);" class="t">[管理分类]</a></td>
</tr>
<tr<?php if(!$_userid) { ?> style="display:none;"<?php } ?>
>
<td class="tl">我的推荐</td>
...
<td align="left" title="<?php echo $v['alt'];?>"><ul><li>&nbsp;<?php if($v['level']==1) { ?><img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/ico_home.gif" title="网站首页推广"/> <?php } ?>
<?php if($v['elite']) { ?><span class="f_red" title="公司主页推荐">[荐]</span> <?php } ?>
<?php if($v['status']==3) { ?><a href="<?php echo $v['linkurl'];?>" target="_blank" class="t"><?php } else { ?><a href="<?php echo $DT['file_my'];?>?mid=<?php echo $mid;?>&action=edit&itemid=<?php echo $v['itemid'];?>" class="t"><?php } ?>
