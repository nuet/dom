...
onblur="if (this.value=='') this.value=this.defaultValue;">
          ...
          <div class="u_rtwo_2_big">
           <table class="tableborder" border="0" cellspacing="0">
              <tr>
                  ...
                  <td width="233" align="center" class="tableTH">项目信息</td>
                  <td width="114" align="center" class="tableTH">项目价格</td>
                  <td width="102" align="center" class="tableTH">付款方式</td>
                  <td width="104" align="center" class="tableTH">实付款</td>
                  <td width="104" align="center" class="tableTH">项目状态</td>
                  <td width="156" align="center" class="tableTH">交易操作</td>
         ...
         <?php if(is_array($list)) { foreach($list as $i => $rm) { ?>
                <tr>
                  <td style="">
                    <div class="u_rtwo_2_1_1"><p class="Grey"><b>订单编号:</b> <?php echo $rm['itemid'];?></p></div>
              <div class="u_rtwo_2_1_1"><p><b>订单时间:</b> <?php echo $rm['addtime'];?></p></div>
              <div class="u_rtwo_2_1_1"><p class="Grey"><b><?php echo $rm['areaid'];?><?php echo $rm['buyer_name'];?></b><br/> </p><p><a href="<?php echo $CFG['url'];?>/mall/order.php?itemid=<?php echo $rm['mallid'];?>">(<?php echo $rm['title'];?>)</a></p></div>
                  </td>
                  <td align="center"><span><?php echo $rm['amount'];?>元<br/><i><?php echo $rm['fapiao_yz'];?></i></span></td>
                  <td align="center"><span><?php echo $rm['pay'];?></span></td>
                  <td align="center">
                    <span><p><?php echo $rm['ready_money'];?>元</p></span>
                  </td>
                  <td align="center"><span><?php echo $rm['status_zt'];?><br/> <a href="trade.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=upload_5&forward=<?php echo $MODULE['2']['linkurl'];?>">订单详情</a></span></td>
                  <td align="center">
                    <span>
       ...
       <?php } else if($rm['status']==1 && $rm['vcheck']==2) { ?>
        ...
        <input type="submit" value="查看栏目页" class="u_btn" onclick="Go('trade.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=lm&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
       <?php } else if($rm['status']==6 ) { ?>
       <input type="button" value="等待程序制作" class="gaoliangG" />
       <?php } else if($rm['status']==7 ) { ?>
         <input type="submit" value="确认验收" class="u_btn" onclick="if(confirm('确认验收么？')) Go('trade.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=receive_goods&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
       <?php } else if($rm['status']==8 ) { ?>
        <input type="submit" value="付款并上线" class="u_btn" onclick="Go('trade.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=pay_3&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
       <?php } else if($rm['status']==9) { ?>
       <?php if($rm['seller_star']) { ?>
      <input type="submit" value="评价详情" class="u_btn" onclick="Go('trade.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=comment_detail&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
      <?php } else { ?>
      <input type="submit" value="评 价" class="u_btn" onclick="Go('trade.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=comment&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
      <?php } ?>
        <?php } else { ?>
      ...
      <table class="tableborder" border="0" cellspacing="0" >
              <tr>
              <td class=""  style='width:804px;height:30px;line-height:30px;font-size:20px;border-right: 1px solid #ccc;text-align:center'><span>您没有订单信息</span></td>
              </tr>
           </table>
    <?php } ?>
...
onblur="if (this.value=='') this.value=this.defaultValue;">
         ...
         <?php if(is_array($lists)) { foreach($lists as $i => $rm) { ?>
                <tr>
                  <td style="">
                    <div class="u_rtwo_2_1_1"><p class="Grey"><b>订单编号:</b> <?php echo $rm['itemid'];?></p></div>
                    <div class="u_rtwo_2_1_1"><p><b>订单时间:</b> <?php echo $rm['addtime'];?></p></div>
                    <div class="u_rtwo_2_1_1"><p class="Grey"><b><?php echo $rm['areaid'];?><?php echo $rm['buyer_name'];?></b><br/> </p><p><a href="<?php echo $CFG['url'];?>/pingmian/order.php?itemid=<?php echo $rm['mallid'];?>">(<?php echo $rm['title'];?>)</a></p></div>
                  </td>
                  <td align="center"><span><?php echo $rm['amount'];?>元<br/><i><?php echo $rm['fapiao_yz'];?></i></span></td>
                  <td align="center"><span><?php echo $rm['pay'];?></span></td>
                  <td align="center">
                  ...
                  <td align="center"><span><?php echo $rm['status_zt'];?><br/> <a href="trades.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=logo&forward=<?php echo $MODULE['2']['linkurl'];?>">订单详情</a></span></td>
                  <td align="center">
                    <span>
            <?php if($rm['pay_style']==0 && $rm['status']==0) { ?>
       ...
       <?php } else if($rm['status']==6 ) { ?>
        <input type="submit" value="程序开发" class="u_btn" onclick="Go('trades.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=design&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
        <?php } else if($rm['status']==7 ) { ?>
        <input type="submit" value="确认完成" class="u_btn" onclick="if(confirm('确认项目已制作完成么？\n\n请注意:确认后您的钱将直接支付给卖家')) Go('trades.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=receive_goods&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
       <?php } else if($rm['status']==8 ) { ?>
        <?php if($rm['seller_star']) { ?>
      <input type="submit" value="评价详情" class="u_btn" onclick="Go('trades.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=comment_detail&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
      <?php } else { ?>
      <input type="submit" value="评 价" class="u_btn" onclick="Go('trades.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=comment&forward=<?php echo $MODULE['2']['linkurl'];?>');"/>
      <?php } ?>
        <?php } else { ?>
        <input type="button" value="等待中" class="gaoliangG" />
        <?php } ?>
...
onblur="if (this.value=='') this.value=this.defaultValue;">
          ...
          <table class="tableborder" border="0" cellspacing="0">
              <tr>
                  ...
                  <td width="233" align="center" class="tableTH">项目信息</td>
                  <td width="114" align="center" class="tableTH">项目价格</td>
                  <td width="102" align="center" class="tableTH">语言版本</td>
                  <td width="104" align="center" class="tableTH">其他信息</td>
                  <td width="104" align="center" class="tableTH">项目状态</td>
                  <td width="156" align="center" class="tableTH">交易操作</td>
                ...
                <tr>
                  <td style="">
                    <div class="u_rtwo_2_1_1"><p class="Grey"><b>订单编号:</b> <?php echo $rm['itemid'];?></p></div>
                    <div class="u_rtwo_2_1_1"><p><b>订单时间:</b> <?php echo $rm['addtime'];?></p></div>
                    <div class="u_rtwo_2_1_1"><p class="Grey"><b><?php echo $rm['areaid'];?><?php echo $rm['name'];?></b><br/> </p><p><a href="<?php echo $CFG['url'];?>/mall/order.php?itemid=<?php echo $rm['mallid'];?>">(<?php echo $rm['title'];?>)</a></p></div>
                  </td>
                  <td align="center"><span><?php echo $rm['amount'];?>元<br/></span></td>
                  <td align="center"><span><p><?php echo $rm['language'];?></p> </span></td>
                  <td align="center">
                    <span><p><?php echo $rm['tc'];?> <?php echo $rm['jf'];?> <?php echo $rm['mob'];?></p></span>
                  </td>
                  <td align="center"><span><?php echo $rm['status_zt'];?><br/><a href="group.php?itemid=<?php echo $rm['itemid'];?>&action=update&step=detail">订单详情</a></span></td>
                  <td align="center">
                    <span>&nbsp;
                      <?php if($rm['status'] == 0) { ?>
                         <input type="button" value="已付款" class="gaoliangG" />
