...
<!-- 建站资料选项卡 -->
  ...
  <div class="js_case clear">
    ...
    <li><a href="design.php?itemid=<?php echo $itemid;?>&action=update&step=logo&forward=<?php echo $_GET['forward'];?>">建站资料</a></li>
        <li><a href="design.php?itemid=<?php echo $itemid;?>&action=update&step=index&forward=<?php echo $_GET['forward'];?>">首页设计</a></li>
        <li class="on"><a href="design.php?itemid=<?php echo $itemid;?>&action=update&step=design&forward=<?php echo $_GET['forward'];?>">PSD上传</a></li>
      </ul>
    </div>
...
<div class="js_product show">
 <div class="u_jzzl" id="u_jzzl">
        ...
        <div class="u_jzzl_tjhshow_bc2 clear">
          <form action="design.php" method="post" enctype="multipart/form-data" class="file-box">
        <i>栏目PSD：</i>
