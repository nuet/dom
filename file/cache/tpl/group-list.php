...
<div class="oyw_tm2"><h3 class="clearfix"><span style="font-size:14px;font-family:微软雅黑; padding:0px 0px;;" class="fl"><?php echo $_truename;?> <?php echo $MG['groupname'];?>，您好</span><span  style="padding-top:13px; margin-left:10px;">
...
<div class="oyw_user clear">
  ...
  <div class="mt5 clear">
   ...
   <?php } else if($_groupid >5) { ?>
       <div class="oyw_tm2"><h3 class="clearfix"><span style="font-size:14px;font-family:微软雅黑; padding:0px 0px;;" class="fl"><?php echo $_company;?> <?php echo $MG['groupname'];?>，您好</span><span  style="padding-top:3px; margin-left:10px;" class="fl">
