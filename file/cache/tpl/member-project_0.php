  ...
  <div class="js_case clear">
    <div class="js_title cf">
     ...
     <li><a href="project.php?itemid=<?php echo $itemid;?>&action=update&step=upload_5&forward=<?php echo $_GET['forward'];?>">建站资料</a></li>
        <li class="on"><a href="project.php?itemid=<?php echo $itemid;?>&action=update&step=index&forward=<?php echo $_GET['forward'];?>">首页设计</a></li>
...
<div class="u_jzzl_index_sj" id="u_jzzl_index_sj">
        ...
        <div class="u_shejisTiJ_ZuoPin_show">
                ...
                <?php if($td['status']==2 || $td['status']==3) { ?>
                <div class="u_shejisTiJ_ZuoPin_show_1">
                    ...
                    <div class="u_jzzl_index_sj_cont6_rt" id="sjg">
                            <ul>
                ...
                <div class="u_shejisTiJ_ZuoPin_time_t"><b>提交首页或修稿稿件：<i>首页提交倒计时：<?php echo $td['lefttime'];?></i>  本套餐中标奖金：<?php echo $malls['last_money'];?> 初稿奖金<?php echo $mal['sm'];?> 入围奖金 <?php echo $mal['rm'];?></b></div>
                <div class="u_shejisTiJ_ZuoPin_time_cont">
                <div class="u_shejisTiJ_ZuoPin_time_lf">
                <b>新上传<input type="hidden" name="post[upload]" id="thumb" value="<?php echo $thumb;?>"/></b>
                <span><img src="<?php if($thumb) { ?><?php echo $thumb;?><?php } else { ?><?php echo DT_SKIN;?>image/waitpic.gif<?php } ?>
" width="100" height="100" id="showthumb" title="预览图片" alt="" onclick="if(this.src.indexOf('waitpic.gif') == -1){_preview(Dd('showthumb').src, 1);}else{Dalbum('',<?php echo $moduleid;?>,<?php echo $MOD1['thumb_width'];?>,<?php echo $MOD1['thumb_height'];?>, Dd('thumb').value, true);}"/>
                    <div class='img_icon'>
                     <img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/img_upload.gif" title="上传" onclick="Dalbum('',<?php echo $moduleid;?>,<?php echo $MOD1['thumb_width'];?>,<?php echo $MOD1['thumb_height'];?>, Dd('thumb').value, true);"/>
                     <img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/img_select.gif"  title="选择" onclick="selAlbum('');"/>
                     <img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/img_delete.gif" title="删除" onclick="delAlbum('','wait');"/></div>
                          </span>
                </div>
...
" width="100" height="100" id="showthumb" title="预览图片" alt="" onclick="if(this.src.indexOf('waitpic.gif') == -1){_preview(Dd('showthumb').src, 1);}else{Dalbum('',<?php echo $moduleid;?>,<?php echo $MOD1['thumb_width'];?>,<?php echo $MOD1['thumb_height'];?>, Dd('thumb').value, true);}"/>
                   <div class='img_icon'>
                   <img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/img_upload.gif" width="12" height="12" title="上传" onclick="Dalbum('',<?php echo $moduleid;?>,<?php echo $MOD1['thumb_width'];?>,<?php echo $MOD1['thumb_height'];?>, Dd('thumb').value, true);"/>
<img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/img_select.gif" width="12" height="12" title="选择" onclick="selAlbum('');"/>
<img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/img_delete.gif" width="12" height="12" title="删除" onclick="delAlbum('','wait');"/></div>
                          </span>
                </div>
                <div class="u_shejisTiJ_ZuoPin_time_min">
