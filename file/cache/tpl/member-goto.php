<?php defined('IN_DESTOON') or exit('Access Denied');?><?php if($action=="password" ) { ?>
...
<!-- 头部结束 -->
  ...
  <div class="N_Res_PWD">
    <div class="N_Res_PWD_lf">
      <div class="N_Res_PWD_lf_img"><img src="<?php echo DT_SKIN;?>image/N_res_PWD2.jpg" alt=""></div>
      <div class="N_Res_PWD_lf_cont">
    
    <!-- 找回密码验证身份 -->
    <div class="N_Rese_yanz">
      <span><input type="text" id="url" value="<?php echo $url;?>"></span>
      <span><a href="#" onclick="go_to();" >登录邮箱</a></span>
    </div>
    <div class="N_Rese_yanz_dui clear">
      <div class="N_Rese_yanz_dui_img"></div>
      <div class="N_Rese_yanz_dui_bg">
        <p>一封验证邮件已经发送您的电子邮箱 <b><?php echo $email;?>，</b>请注意查收</p>       
      </div>
      <div class="N_Rese_yanz_P">
        <p> <b>没有收到邮件？</b><br/></p>
        <p> 1、尝试到广告邮件和垃圾邮件里找找看（被误屏蔽）</p>
        <p>2、将<?php echo $DT['mail_sender'];?>加入您的邮件白名单，然后重试</p>
      </div>
    </div>
    <!-- 找回密码验证身份结束 -->       
    ...
    <div class="N_Res_PWD_rt">
      <div class="N_Res_PWD_rt_t">
        >>  我已经找回密码，现在就 <i><a href="login.php">登录</a></i>
      </div>
...
<div class="NeLoHeaer">
  <div class="N_L_logo">
    <span><img src="<?php echo DT_SKIN;?>image/Login_Logo.fw.jpg" alt=""><i>帐号注册</i></span>
    <p><a href="<?php echo $CFG['url'];?>">返回首页</a> | <a href="">帮助中心</a> | <a href="">联系客服</a></p>
  </div>
</div>
<div class="R_link">
<div class="R_link_B">
 ...
 <a href="<?php echo $MODULE['2']['linkurl'];?><?php echo $DT['file_register'];?>"  class="<?php echo $rs['a'];?>">客户</a>
    <a href="<?php echo $MODULE['2']['linkurl'];?>register_company.php"  class="<?php echo $rs['b'];?>">设计师</a>
  </div>
</div>
</div>
<div class="Regist_cont">
  <div class="Regist_cont_lf">
    <div class="Regist_buzhouimg">
      <!--   <img src="images/Regist_buzhouimg3.jpg" alt=""> -->
    </div>
    <!-- 注册成功了 -->
    <div class="Regist_chengg">
      <span><i>恭喜，<?php echo $rs['username'];?> 已经注册成功！</i></span>
      <span class="mt30">
        <a href="<?php echo $CFG['url'];?>" class="huidaoshouye">回到首页</a>
        <!-- <a href="" class="jinruhuiyuan">进入会员中心</a> -->
      </span>
     
        <div class="Regist_chengg_on clear">
        <p>超过<i>80%</i>的用户选择了立即验证邮箱，成为我们的正式会员。</p>
        </div>
        <div class="Regist_chengg_email">
         <input type="text" id="url" value="<?php echo $url;?>">
          <a href="#" onclick="go_to();"  >登录邮箱</a>
        </div>
        <div class="Regist_chengg_email_bg clear">
          <p>一封验证邮件已经发送您的电子邮箱<?php echo $email;?>,请注意查收</p>
        </div>
        <div class="Regist_chengg_help">
        <p> <b>没有收到邮件？</b><br/></p>
        <p> 1、尝试到广告邮件和垃圾邮件里找找看（被误屏蔽）</p>
        <p>2、将<?php echo $DT['mail_sender'];?>加入您的邮件白名单，然后点击<a href="send.php?action=check">重新发送</a></p>
      </div>
    </div>
  </div>
  <div class="Regist_cont_rt">
    <div class="Regist_cont_rt_1">
      <p>>>  我已经注册，现在就 <a href="login.php">登录</a></p>
    </div>
    <div class="Regist_cont_rt_2">
        <p><a href="login.php" class="N_login_rt">登录</a></p>
