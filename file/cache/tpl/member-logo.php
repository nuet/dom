  ...
  <div class="js_case clear">
    <div class="js_title cf">
      ...
      <ul class="js_title-list cf">
             <li class="on"><a href="trades.php?itemid=<?php echo $itemid;?>&action=update&step=logo&forward=<?php echo $_GET['forward'];?>">平面需求</a></li>
        <li ><a href="trades.php?itemid=<?php echo $itemid;?>&action=update&step=logo_index&forward=<?php echo $_GET['forward'];?>">平面设计</a></li>
...
<div class="u_jzzl_fram_index_cont_t"><span><b>网站首页架构</b>
<input type="radio" value="左右结构" name="indexjg">左右结构
<input type="radio" value="上下结构" name="indexjg">上下结构
...
<b>自己手写或工具制作的首页及其他页面框架图片（可选）：<input name="post[kj]" id="fileurl6" type="text" size="50" value="<?php echo $fileurl4;?>"/><?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl6').value, 'fileurl6', 'jpg|png|gif');" >选择文件</b><?php } ?>
</b>
<i><a href="">例子下载>></a></i>
</div>
</div>
...
<span><a href=""><img src="<?php echo DT_SKIN;?>/image/u_add_web.jpg" alt=""></a>
<a href="#" onClick="showinput('1')">添加网址</a>
</span>
</div>
<div class="u_jzzl_ckweb_cont_1">可参考布局网站地址:
<input type="text" value="" name="pot2[bjweb0]"><span><a href=""><img src="<?php echo DT_SKIN;?>/image/u_add_web.jpg" alt=""></a>
<a href="#" onClick="showinput('2')">添加网址</a>
</span>
</div>
<div class="u_jzzl_ckweb_cont_1">可参考栏目网站地址:
<input type="text" value="" name="pot3[lmweb0]"><span><a href=""><img src="<?php echo DT_SKIN;?>/image/u_add_web.jpg" alt=""></a>
<a href="#" onClick="showinput('3')">添加网址</a>
</span>
</div>
...
<input name="post[contact]" id="fileurl2" type="text" size="50" value="<?php echo $fileurl2;?>"/><?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;<b onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl2').value, 'fileurl2', 'doc|txt');" >选择文件</b><?php } ?>
<span> 支持文件格式：doc,txt <a href=""><i>例子下载>></i></a></span>
</div>
<div class="u_jzzl_sxcl_cont_1">网站栏目结构
<input name="post[lm]" id="fileurl3" type="text" size="50" value="<?php echo $fileurl3;?>"/><?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;<b onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl3').value, 'fileurl3', 'doc|rar|zip');">选择文件</b><?php } ?>
 
<span>支持文件格式：DOC,RAR,ZIP <a href=""><i>例子下载>></i></a></span>
</div>
<div class="u_jzzl_sxcl_cont_1">网站主题图片及广告语
<input name="post[ad]" id="fileurl5" type="text" size="50" value="<?php echo $fileurl4;?>"/><?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;<b onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl5').value, 'fileurl5', 'rar|zip');" >选择文件</b><?php } ?>
<span> 支持文件格式：rar,zip图片和文字打包 <a href=""><i>例子下载>></i></a></span>
</div>
<div class="u_jzzl_sxcl_cont_1"><i>产品、服务、新闻、案例等资料(此项可后期补充)：</i>
<input name="post[server]" id="fileurl4" type="text" size="50" value="<?php echo $fileurl4;?>"/><?php if($MG['upload'] && check_group($_groupid, $MOD['group_upload'])) { ?>&nbsp;&nbsp;<b onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl4').value, 'fileurl4', 'doc|rar|zip');">选择文件</b><?php } ?>
...
totalnum=totalnum+i;
if(n==1){
str+="<p><div class='u_jzzl_ckweb_cont_1'>增加的配色网站地址: <input type='text' name=\"pot1[psweb"+totalnum+"]\" id='title["+totalnum+"]'  /></p>";
}else if(n==2){
str+="<p><div class='u_jzzl_ckweb_cont_1'>增加的布局网站地址: <input type='text' name=\"pot2[bjweb"+totalnum+"]\" id='title["+totalnum+"]'  /></p>";
}else{
str+="<p><div class='u_jzzl_ckweb_cont_1'>增加的栏目网站地址: <input type='text' name=\"pot3[lmweb"+totalnum+"]\" id='title["+totalnum+"]'  /></p>";
}
}
