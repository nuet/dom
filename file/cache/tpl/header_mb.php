...
<link href="<?php echo DT_SKIN;?>/M_Y_Qiye.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="<?php echo DT_SKIN;?>MoBan_Ye_Index.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo DT_SKIN;?>M_Y_Cont.css"/>
...
<link rel="stylesheet" type="text/css" href="<?php echo $CFG['url'];?>file/script/mayabox/style3.css">
...
<script type="text/javascript" src="<?php echo DT_STATIC;?>/file/script/moban.js"></script>
</head>
<body>
...
<li><a href="javascript:gocity('areaid=35')">深圳</a></li>
 ...
 <div class="MoBanLogoLi">
    <img src="http://www.omooo.com.cn/skin/default/image/MoBanLogoLi.gif" alt="">
    <p>上海：021-51875581</p>
  </div>
  <!-- 联系方式结束 -->
</div>
    ...
    <div class="M_YNav">
        <div class="M_YNav_lf" >
          <ul id="Newjsddm" class="Newjsddm">
              ...
              <li><a href="<?php echo $MODULE['6']['linkurl'];?>"  target="_blank" class="topli">个性定制&nbsp;&nbsp;<em></em></a></li>
