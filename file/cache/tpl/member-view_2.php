...
<div class="u_jzzl_chengxukaifa" id="u_jzzl_chengxukaifa">
       ...
       <div class="u_jzzl_chengxukaifa_cont_rt">
       <span style="height:100px;line-height:100px;color:#FF6303"><b>温馨提示:</b>客官，程序正在加紧制作中。请耐心等待邮件或短信通知</span>
...
<span>网站尾款：<i>￥<?php echo $td['price3'];?></i><input type="submit" value="验收付款" onclick="if(confirm('确认验收么？')) Go('trade.php?itemid=<?php echo $itemid;?>&action=update&step=receive_goods&forward=<?php echo $MODULE['2']['linkurl'];?>');"></span>
       </div>
