...
<div class="R_link_B">
  <div class="R_link_div">
    <a href="<?php echo $MODULE['2']['linkurl'];?><?php echo $DT['file_register'];?>" >客户</a>
    <a href="<?php echo $MODULE['2']['linkurl'];?>register_company.php" class="on">设计师</a>
  </div>
</div>
</div>
    ...
    <div class="N_NextB">
     ...
     <div class="N_Name">
      <span class="N_Left"><b> * </b>真实姓名：</span>
          <div>
          <input type="text" class="inp_username Reg_form_he" name="post[truename]" id="truename" onblur="validate('truename');"/>
...
/>
    ...
    <div class="N_Name">
      <span class="N_Left"><b> * </b>设计师昵称：</span>
          <div>
        <input type="text" class="inp_username Reg_form_he"  placeholder="注册号不能更改" name="post[company]" id="company" onblur="validator('company');"/>
      <label></label>
   <span id="dcompany" class="f_red"></span>
     ...
     <div class="N_Name">
      <span class="N_Left"><b> * </b>身份证号码：</span>
          <div>
        <input type="text" class="inp_username Reg_form_he"  name="post[idcard]" id="idcard" onblur="validate('idcard');"/>
   <span id="didcard" class="f_red"></span>
  ...
  <div class="N_Code">
     ...
     <div>
       ...
       <span id="dcaptcha" class="code_img_yanok"></span>
      </div>
    </div>
    <div class="N_NextB">
...
//Dd('d'+vid).innerHTML = xmlHttp.responseText ? '<span class="Reg_form_red"></span>' : '<img src="<?php echo DT_SKIN;?>image/check_right.gif" align="absmiddle"/> ';
