...
<strong>尊敬的<?php echo $person['username'];?></strong>：<br/>
恭喜你！您好！您的定制网站项目订单号为：<span style="color:#FF1100;"><?php echo $itemid;?></span>的订单程序已制作完成。请查看并验收。请点击下面查看订单（如果显示的不是链接，请将下面的地址复制到浏览器的地址栏里按下回车键）<br/>
