...
<div class="warn">贵设计师尚未完善详细资料！完善的商业信息有助于获得别人的信任，结交潜在的商业伙伴，获取商业机会，请尽快完善</div>
<?php } ?>
<?php if(isset($success)) { ?>
<div class="ok">资料保存成功，您可以：<a href="edit.php" class="t">继续完善</a> &nbsp;|&nbsp; <a href="<?php echo $DT['file_my'];?>" class="t">发布信息</a> &nbsp;|&nbsp; <a href="./" class="t">返回会员中心</a></div>
<?php } ?>
<div class="menu">
...
<?php if($is_company) { ?>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="Tab2"><a href="javascript:Tab(2);"><span>设计师资料</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="Tab3"><a href="javascript:Tab(3);"><span>设计师联系方式</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="Tab4"><a href="javascript:Tab(4);"><span>设计师介绍</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="Tab4"><a href="validate.php?action=company"><span>设计师认证</span></a></td>
<?php } ?>
</tr>
</table>
</div>
...
<tr>
<td class="tl">身份证号</td>
<td class="tr"><input name="post[idcard]" type="text" size="60" id="idcard" value="<?php echo $idcard;?>"/>&nbsp;&nbsp;<br/>
</tr>
<tr>
<td class="tl">形象图片</td>
...
<span class="f_gray">，最佳大小为286px * 187px</span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span>所在地区</td>
<td class="tr"><?php echo ajax_area_select('post[areaid]', '请选择', $areaid);?>&nbsp;<span id="dareaid" class="f_red"></span></td>
...
<tr>
<td class="tl"><span class="f_red">*</span>介绍</td>
...
Tab(4);
Dmsg('设计师介绍不能少于10字，当前已经输入'+FCKLen('introduce')+'字', 'introduce');
return false;
}
<?php } ?>
return true;
